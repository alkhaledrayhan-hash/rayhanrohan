    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        <img
          ...
          width={1280}
          height={896}
          className="h-full w-full object-cover transform-gpu transition-transform duration-[4000ms] ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform group-hover:scale-[1.08]"
        />
