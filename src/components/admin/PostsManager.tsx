                    ...
                    <tr key={p.id} className="hover:bg-muted/30">
                      ...
                      <td className="px-5 py-3">
                        <div className="flex min-w-0 items-center gap-2">
                          <p className="admin-cell font-medium" title={p.title}>{p.title}</p>
                          {p.is_featured && (
                        ...
                        <p className="admin-cell text-[11px] text-muted-foreground" title={`/${p.slug}`}>/{p.slug}</p>
                      </td>
                      <td className="px-5 py-3">
          ...
          <tbody className="divide-y divide-border">
            ...
            {items.map((it) => (
              <tr key={it.id} className="hover:bg-muted/30">
                <td className="px-4 py-2.5 font-medium"><span className="admin-cell" title={it.name}>{it.name}</span></td>
                <td className="px-4 py-2.5 text-muted-foreground"><span className="admin-cell" title={`/${it.slug}`}>/{it.slug}</span></td>
